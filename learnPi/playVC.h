...
@property (strong, nonatomic) IBOutlet NSString *pi;
@property (nonatomic) int currentDigit;
@property (nonatomic) CGFloat screenWidth;
@property (nonatomic) CGFloat screenHeight;
@property (strong, nonatomic) IBOutlet NSString *piRealString;
@property (nonatomic) colors *colorInst;
